This is a [Next.js](https://nextjs.org/) mock project for Village bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
